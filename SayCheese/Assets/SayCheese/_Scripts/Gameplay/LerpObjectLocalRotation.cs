...
public  class LerpObjectLocalRotation : MonoBehaviour
{
    public static LerpObjectLocalRotation instance;
    bool toLerp = false;
    float lerpSpeed;
    float lerpTime;
    ...
    void Update()
    {
        ...
        currentObject.transform.localRotation = Quaternion.Lerp(initRot,finalRot,lerpTime);
